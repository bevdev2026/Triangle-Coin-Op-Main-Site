...
<section class="hero hero-short">
  ...
  <div class="hero-inner">
    <div class="hero-eyebrow"><?= htmlspecialchars($SITE['parent_co']) ?></div>
    <h1 class="hero-title">Venue Operations</h1>
    <p class="hero-tagline">Bring Machines Into Your Space</p>
  </div>
</section>
...
<section class="section section-dark">
  <div class="container">
    <div class="text-center mb-xl">
      <span class="section-tag">01: What We Bring</span>
      <h2 class="section-title">Built Around Your Venue</h2>
    </div>

    <div class="grid-4">
      <div class="feature">
        <!-- Compass icon -->
        <svg class="feature-icon" viewBox="0 0 64 64" fill="none" stroke="currentColor" stroke-width="2" style="color: var(--gold);">
          <circle cx="32" cy="32" r="26"/>
          <circle cx="32" cy="32" r="3" fill="currentColor"/>
          <path d="M32 8 L36 32 L32 56 L28 32 Z" fill="currentColor" opacity="0.6"/>
        </svg>
        <h3 class="feature-title">The Right Machine for Your Room</h3>
        <p class="feature-desc">We match machines to your clientele, square footage, and traffic patterns. No guesswork on your end.</p>
      </div>
      ...
      <div class="feature">
        ...
        <h3 class="feature-title">We Handle Everything</h3>
      ...
      <div class="feature">
        ...
        <h3 class="feature-title">Always in Play</h3>
      ...
      <div class="feature">
        ...
        <h3 class="feature-title">Your Space Becomes the Destination</h3>
        <p class="feature-desc">Recurring league nights bring repeat patrons. Pinball draws a loyal crowd that drinks, eats, and stays.</p>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="grid-2">
      <div>
        ...
        <h2 class="section-title">Let's Find the Right Fit</h2>
        <p class="section-desc">
          Tell us about your space and we'll take it from there. We handle the logistics,
      ...
      <div class="form-card">
        <form action="form-handler.php" method="post">
          ...
          <button type="submit" class="btn btn-primary" style="width:100%">Send Intake</button>
        </form>
      </div>
    </div>
  </div>
